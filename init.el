...
(setq package-archive-priorities '(("melpa" . 3) ("gnu" . 2) ("nongnu" . 1)))
  ...
  (modus-themes-with-colors
   ...
   (custom-set-faces
    ...
    `(fill-column-indicator
      ((,c :height 1.0 :background ,nil :foreground ,bg-active)))
...
(setopt whitespace-line-column 79 whitespace-style '(face tabs lines-tail))
...
(setopt make-backup-files nil require-final-newline t)
...
(setopt corfu-cycle t corfu-echo-delay 0.1 corfu-popupinfo-delay nil)
...
(setopt vc-handled-backends '(Git) log-edit-maximum-comment-ring-size 1000)
...
(defun commit-message-completion ()
  ...
  (insert
   (completing-read
    "History: "
    (-remove
     (lambda (item) (string-match-p (regexp-quote "Summary: ") item))
     (delete-dups
  ...
  (setopt
   ...
   '(("Name" 25 magit-repolist-column-ident nil)
     ...
     ("Flag"
      ...
      ((:right-align t) (:help-echo "U[N]tracked [U]nstaged [S]taged")))
     ("⇣"
      3
...
(setopt
 ...
 '(("NEXT" . '(modus-themes-fg-green modus-themes-nuanced-green org-todo))
   ("DOING" . '(modus-themes-fg-yellow modus-themes-nuanced-yellow org-todo))))
...
(setopt
 ...
 '(("j"
    "Journal Entry"
    entry
    (file+olp+datetree "~/src/notes/work.org")
    "* %?"
    :empty-lines 1)))
...
(setopt rainbow-html-colors nil rainbow-x-colors nil)
